        ...
        <div className="space-y-16 relative">
          ...
          {portfolioData.experience.map((job, index) => (
            <Reveal key={index} delay={index * 100}>
              <div className="group relative grid grid-cols-1 md:grid-cols-[1fr_3fr] gap-4 md:gap-8 items-baseline">
                ...
                <div className="text-left md:text-right md:pr-8 relative">
                  ...
                  <p className="text-sm font-mono text-accent mb-1">{job.period}</p>
                  <p className="text-base font-medium text-zinc-300">{job.company}</p>
                </div>

                {/* Content Card with Tilt & Glow Effect */}
                <Tilt>
