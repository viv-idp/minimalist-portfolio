pipeline {
    ...
    post {
        always {
            ...
            sh 'docker rmi $DOCKER_HUB_REPO-backend:$BUILD_NUMBER $DOCKER_HUB_REPO-frontend:$BUILD_NUMBER || true'
        }
        success {
...
// added line to trigger pipeline on commit to debug-branch
